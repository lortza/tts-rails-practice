...
Type.create(name: "Lizard")
Type.create(name: "Termite")
Type.create(name: "Milipede")
Type.create(name: "Hermit Crab")
Type.create(name: "Gecko")
Type.create(name: "Howler Monkey")
Type.create(name: "Capybara")
Type.create(name: "Ocelot")
Type.create(name: "Sheep")
Type.create(name: "Alpaca")
Type.create(name: "Llama")
Type.create(name: "Bat")
Type.create(name: "Horse")
Type.create(name: "Cow")
Type.create(name: "Goat")
Type.create(name: "Elephant")
